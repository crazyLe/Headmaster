...
- (instancetype)init {
    if ((self = [super initWithFrame:CGRectMake(0, 0, Size, Size)])) {
        ...
        [self.layer setCornerRadius:Size/2];
...
+ (void)showWithOverlaytime:(NSInteger)time {
    
    // dismiss after 2 seconds
    
//    [self dismiss:^{
        [APPDELEGATE.window addSubview:[[self instance] overlayss]];
        [self show];
//    }];
...
+ (void)dismiss {
    ...
    [[[self instance] overlayss] removeFromSuperview];
