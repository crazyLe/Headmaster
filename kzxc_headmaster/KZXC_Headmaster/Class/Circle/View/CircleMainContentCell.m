...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        self.vipImageView.image = [UIImage imageNamed:@"purse_vip"];
        [self.contentView addSubview:self.vipImageView];
        
        //置顶
        self.topBestImageView = [[UIButton alloc]init];
        
        [self.topBestImageView setBackgroundImage:[UIImage imageNamed:@"zhiding"] forState:UIControlStateNormal];
        [self.topBestImageView setTitle:@"置顶" forState:UIControlStateNormal];
        self.topBestImageView.titleLabel.font = Font12;
        [self.topBestImageView setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        ...
        [self.commentBtn setImage:[UIImage imageNamed:@"circle_comment"] forState:UIControlStateNormal];
        ...
        [self.zanBtn setImage:[UIImage imageNamed:@"circle_zan_h"] forState:UIControlStateNormal];
//        [self.zanBtn setImage:[UIImage imageNamed:@"circle_zan"] forState:UIControlStateHighlighted];
        ...
        self.perfectCommentImageView.image = [UIImage imageNamed:@"circle_god"];
        //神评赞
        self.commentZanBtn = [[UIButton alloc]init];
        self.commentZanBtn.titleEdgeInsets = UIEdgeInsetsMake(0, 5, 0, 0);
        [self.commentZanBtn setImage:[UIImage imageNamed:@"circle_zan"] forState:UIControlStateNormal];
        [self.commentZanBtn setImage:[UIImage imageNamed:@"circle_zan_h"] forState:UIControlStateNormal];
...
-(void)setupData
{
    ...
    [self.iconImageView sd_setImageWithURL:url placeholderImage:[UIImage imageNamed:@"placeHeader"]];
    ...
    for (int i = 0; i<self.imageViewsArray.count; i++) {
        ...
        [imageView sd_setImageWithURL:url placeholderImage:[UIImage imageNamed:@"placehold"]];
    }
    ...
    if (self.circleFrameModel.circleMainModel.is_praise==1) {//赞过
        [self.zanBtn setImage:[UIImage imageNamed:@"circle_zan"] forState:UIControlStateNormal];
    }
    else
    {
        [self.zanBtn setImage:[UIImage imageNamed:@"circle_zan_h"] forState:UIControlStateNormal];
    ...
    if(self.circleFrameModel.circleMainModel.comemnt.addtime != nil)//有评论
    {
        ...
        [self.commentIconImageView sd_setImageWithURL:url placeholderImage:[UIImage imageNamed:@"placeHeader"]];
